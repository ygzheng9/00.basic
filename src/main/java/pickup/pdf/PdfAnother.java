...
public class PdfAnother {

  private static String FILE = "HelloWorld_Another.pdf";
  ...
  private static void addTitlePage(Document document)
    ...
    preface.add(new Paragraph(
        "Report generated by: " + System.getProperty("simple.name") + ", " + LocalDate.now(),
  ...
  private static void alignPara(Document document) throws DocumentException {
    // Left
